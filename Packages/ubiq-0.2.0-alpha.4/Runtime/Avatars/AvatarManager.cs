...
namespace Ubiq.Avatars
{
    ...
    public class AvatarManager : MonoBehaviour
    {
        ...
        // RealityFlow addition: Added public static string UUID
        // Purpose: To have access to 'peer.uuid' in NetworkedPalette.cs to set palette ownership
            ...
            IPeer peer, NetworkSpawnOrigin origin)
        {
            ...
            if (peer == RoomClient.Me)
            {
                ...
                // RealityFlow addition: Added if (UUID == null) { UUID = peer.uuid; }
                // Purpose: To assign UUID to the owner of the palette
                if (UUID == null) {
                    UUID = peer.uuid;
                }
